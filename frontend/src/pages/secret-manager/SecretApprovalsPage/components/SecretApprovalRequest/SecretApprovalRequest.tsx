              ...
              <TableBody>
                ...
                {secretApprovalRequests.map((secretApproval) => {
                  ...
                  if (status === "close") {
                    ...
                    statusDisplay = { label: "Pending merge", type: "success", icon: GitMergeIcon };
                  } else {
                    statusDisplay = {
                  ...
                  return (
                    <TableRow
                      ...
                      key={reqId}
                      tabIndex={0}
                      onClick={() => navigate({ search: { requestId: reqId } })}
                      onKeyDown={(evt) => {
                        if (evt.key === "Enter") navigate({ search: { requestId: reqId } });
                      }}
                    >
                      <TableCell>
