...
export const ProjectTemplateEnvironmentsForm = ({ projectTemplate }: Props) => {
  const {
    control,
    handleSubmit,
  ...
  return (
    ...
    >
      <div className="mb-4 flex items-center justify-between border-b border-mineshaft-400 pb-4">
        ...
        <OrgPermissionCan I={OrgPermissionActions.Edit} a={OrgPermissionSubjects.ProjectTemplates}>
          {(isAllowed) => (
            <Button
              type="submit"
              colorSchema="primary"
              ...
              <Tr key={id}>
                ...
                <Td className="flex items-center justify-end">
                  ...
                  >
                    {(isAllowed) => (
                      <IconButton
                        className={`mr-3 py-2 ${pos === 0 ? "pointer-events-none opacity-50" : ""}`}
                        onClick={() => move(pos, pos - 1)}
                        colorSchema="primary"
                        variant="plain"
