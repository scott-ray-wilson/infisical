  ...
  return (
    <>
      ...
      >
        ...
        <div className="mt-1.5 flex w-full justify-between rounded bg-mineshaft-600 px-2 py-1 text-xs">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-1">
                  ...
                  <span className="capitalize">{ACTION_NAME_MAP[subject][action]}</span>
                </div>
              </Tooltip>
            );
          })}
