...
export const FolderNode = ({
  ...
  return (
    <>
      ...
      />
      <div
        className={`flex ${canRead || canCreate || canEdit || canDelete ? "" : "opacity-40"} h-full w-full flex-col items-center justify-center rounded-md border border-mineshaft bg-mineshaft-800 px-2 py-2 font-inter shadow-lg`}
      >
