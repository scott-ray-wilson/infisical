  ...
  if (hasCustomBranding) {
    return (
      <>
        ...
        <div
          className="flex min-h-screen flex-col items-center justify-center overflow-auto px-4 py-10"
        ...
        >
          {brandingConfig?.hasLogo && (
            <img
              src={logoUrl}
              alt="Logo"
              className="mb-8 max-h-16 w-auto object-contain"
            />
          )}
          <div
          ...
          >
            <h1
              ...
              style={{ color: brandingTheme?.textColor }}
            >
              View shared secret
            </h1>
            {secretContent}
