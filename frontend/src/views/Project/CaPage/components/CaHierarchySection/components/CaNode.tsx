...
export const CaNode = ({ data }: NodeProps & { data: TCertificateAuthority }) => {
  ...
  return (
    <>
      ...
      />
      <div className="flex h-full w-full flex-col items-center justify-center rounded-md border border-mineshaft bg-mineshaft-900 px-3 py-2 font-inter shadow-lg">
        <div
