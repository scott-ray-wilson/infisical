            ...
            <div className="p-4">
              ...
              {labels?.map((el, index) => (
                <div key={`approval-list-${index + 1}`} className="flex">
                  ...
                  <div className="grid flex-1 grid-cols-3 border-b border-mineshaft-600 p-4">
                    <GenericFieldLabel icon={faUser} label="Users">
                      {el.userLabels}
                    </GenericFieldLabel>
                    <GenericFieldLabel icon={faUserGroup} label="Groups">
                      {el.groupLabels}
                    </GenericFieldLabel>
