...
<Tabs>
    <Tab title="Infisical UI">
        ...
        4. Specify the Distinguished Name (DN) or User Principal Name (UPN) of the principal whose password you want to rotate and configure the password requirements. Then click **Next**.
        ...
        ![Rotation Secrets Mapping](/images/secret-rotations-v2/ldap-password/ldap-password-secrets-mapping.png)
            ...
            - **DN** - the name of the secret that the principal's Distinguished Name (DN) or User Principal Name (UPN) will be mapped to.
