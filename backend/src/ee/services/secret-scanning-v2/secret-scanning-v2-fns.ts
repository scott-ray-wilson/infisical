...
import { SecretRotation, SecretRotationStatus } from "./secret-scanning-v2-enums";

const SECRET_SCANNING_LIST_OPTIONS: Record<SecretRotation, TSecretRotationV2ListItem> = {
