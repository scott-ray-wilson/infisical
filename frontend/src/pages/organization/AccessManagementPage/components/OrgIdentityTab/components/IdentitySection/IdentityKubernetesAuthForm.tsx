                    ...
                    >
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-md">
                          ...
                          Reviewer, the selected gateway will be used to review tokens with. If this
                          option is enabled, the gateway must be deployed in Kubernetes, and the
                          gateway must have the system:auth-delegator ClusterRole binding.
                        </TooltipContent>
                      </Tooltip>
                    </FieldLabel>
            ...
            <Controller
              ...
              render={({ field, fieldState: { error } }) => (
                <Field>
                  ...
                  <Input {...field} id="allowedAudience" type="text" isError={Boolean(error)} />
                  <FieldError>{error?.message}</FieldError>
                </Field>
              )}
            />
