...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-[orientation=horizontal]/tabs:h-8 group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col data-[style=underline]:rounded-none",
  {
    variants: {
      variant: {
        filled: "bg-muted",
...
function TabsTrigger({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.Trigger>) {
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "relative inline-flex h-[calc(100%-1px)] flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-md border border-transparent",
        "px-1.5 py-0.5 text-sm font-medium whitespace-nowrap text-foreground/60 transition-all group-data-[orientation=vertical]/tabs:w-full",
        ...
        "has-data-[icon=inline-end]:pr-1 has-data-[icon=inline-start]:pl-1 group-data-[style=filled]/tabs-list:data-[state=active]:shadow-sm",
        "group-data-[style=underline]/tabs-list:data-[state=active]:shadow-none [&_svg]:pointer-events-none",
        "group-data-[style=underline]/tabs-list:bg-transparent group-data-[style=underline]/tabs-list:data-[state=active]:bg-transparent [&_svg]:shrink-0",
