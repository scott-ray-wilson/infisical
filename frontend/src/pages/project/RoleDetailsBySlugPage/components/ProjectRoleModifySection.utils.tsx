...
export const PROJECT_PERMISSION_OBJECT: TProjectPermissionObject = {
  ...
  [ProjectPermissionSub.SecretRotation]: {
    ...
    actions: [
      { label: "Read", value: ProjectPermissionSecretRotationActions.Read },
      {
        label: "Read Generated Credentials",
        value: ProjectPermissionSecretRotationActions.ReadGeneratedCredentials
      },
      { label: "Create", value: ProjectPermissionSecretRotationActions.Create },
      { label: "Modify", value: ProjectPermissionSecretRotationActions.Edit },
      { label: "Remove", value: ProjectPermissionSecretRotationActions.Delete },
