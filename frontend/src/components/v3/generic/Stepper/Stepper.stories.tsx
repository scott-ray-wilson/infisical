    ...
    <div className="flex w-[260px] flex-col gap-4">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="rounded-md border border-border px-3 py-1 text-xs text-foreground/70 hover:text-foreground"
        >
          Back
        </button>
        <button
          ...
          className="rounded-md bg-primary px-3 py-1 text-xs font-medium text-mineshaft-900"
        >
          Next
        </button>
      </div>
