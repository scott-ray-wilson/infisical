          ...
          {!isPending && (
            <CardAction>
              <OrgPermissionCan I={OrgPermissionActions.Create} a={OrgPermissionSubjects.Sso}>
                {(isAllowed) => (
                  <Button variant="outline" isDisabled={!isAllowed} onClick={addSSOBtnClick}>
                    Manage
                  </Button>
                )}
              </OrgPermissionCan>
                      ...
                      <TooltipContent className="max-w-lg">
                        ...
                        <p className="mt-3 flex items-start gap-1.5 text-warning">
                          ...
                          <span>
                            ...
                            provider will not be reflected in Infisical until their next SAML
                            login. Enable Enforce SAML SSO to ensure this behavior.
                          </span>
                        </p>
                      </TooltipContent>
                    </Tooltip>
