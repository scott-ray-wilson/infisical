            ...
            {description && (
              <Tooltip>
                <TooltipTrigger asChild>
                  <InfoIcon className="ml-1 size-3 text-mineshaft-400" />
                </TooltipTrigger>
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <div>
            ...
            <p className="truncate text-xs leading-4 text-bunker-300">{environmentName}</p>
          </div>
        </TooltipTrigger>
        <TooltipContent side="left" className="max-w-2xl break-words">
          <p className="text-sm">{folderPath}</p>
          <p className="text-xs leading-3 text-bunker-300">{environmentName}</p>
        </TooltipContent>
      </Tooltip>
    </TableCell>
  );
