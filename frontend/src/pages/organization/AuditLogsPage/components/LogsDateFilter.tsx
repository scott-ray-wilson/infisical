        ...
        <div className="flex items-center">
          {filter.type === AuditLogDateFilterType.Relative ? (
            <>
              {RELATIVE_VALUES.map((el) => (
                <Button
                  variant="outline_bg"
                  className={twMerge(
                    "w-12 rounded-none px-3 py-2 font-normal first:rounded-l-md",
                    filter.type === AuditLogDateFilterType.Relative &&
            ...
            <>
              ...
              <div className="border border-transparent bg-mineshaft-600 py-2 text-sm text-bunker-300">
          ...
          <DropdownMenuTrigger asChild>
            <Button
              variant="outline_bg"
              className={twMerge(
                "rounded-none rounded-r-md px-3 py-2 font-normal",
