...
import { TProjectTemplatesServiceFactory } from "@app/ee/services/project-templates/project-templates-service";
...
declare module "fastify" {
  ...
  interface FastifyInstance {
    services: {
      ...
      projectTemplates: TProjectTemplatesServiceFactory;
    };
