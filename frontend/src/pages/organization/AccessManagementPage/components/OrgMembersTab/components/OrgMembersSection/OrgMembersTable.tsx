...
type Props = {
  ...
  isRemoveMembersModalOpen: boolean;
...
export const OrgMembersTable = ({
  ...
  return (
    <div>
      {!isRemoveMembersModalOpen && selectedMemberIds.length > 0 && (
        <div className="fixed bottom-4 left-1/2 z-50 w-full max-w-2xl -translate-x-1/2 rounded-md border border-primary/50 bg-mineshaft-800 text-sm text-primary-200 lg:ml-[120px]">
          <div className="flex items-center gap-x-3 bg-primary/10 px-3 py-2">
            ...
            <Button
              variant="outline_bg"
              size="xs"
              className="ml-auto border-red/50 bg-red/30 hover:border-red/40 hover:bg-red/50"
              onClick={() => {
